...
# TODO: Replace with your LemonSqueezy product checkout URL.
# Find it at: https://app.lemonsqueezy.com → Your Store → Products → Share
...
class ActivationDialog(ctk.CTkToplevel):
    ...
    def __init__(
        ...
        self.title("Activate Pro License")
    ...
    def _build_ui(self, current_key: str) -> None:
        ...
        ctk.CTkLabel(
            self,
            # TODO: describe your app's Pro features here
            text="Purchase a Pro license to unlock premium features.",
