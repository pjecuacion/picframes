...
# TODO: Replace with your app's Buy Me a Coffee (or other donation) URL.
# Remove the button entirely if you don't want it.
_DONATION_URL = "https://buymeacoffee.com/your-username"  # TODO


class BannerFrame(ctk.CTkFrame):
    """Top application bar: donate button, dark-mode toggle, license badge.

    Intentionally inverse of the app theme — dark banner in light mode, light banner in dark mode.
    Do not change fg_color to theme.BG or theme.SURFACE or the inverse contrast is lost.
    """
    ...
    def _build(self, on_toggle: Callable[[], None], appearance_mode: str) -> None:
        ctk.CTkLabel(
            self,
            text="Enjoying My App? Support future updates.",  # TODO: rename
