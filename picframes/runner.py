...
def run_jobs(
    ...
    def _work() -> None:
        ...
        total = len(jobs)
        # rembg loads a 176MB ONNX model per process; running multiple workers
        # in parallel causes concurrent downloads and concurrent ONNX sessions.
        # One worker serialises the AI inference which is already CPU-bound.
        max_workers = 1 if options.remove_bg else _WORKERS
